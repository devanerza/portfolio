    ...
    <section id="top" className="relative -mt-16 overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 pb-20 pt-16 md:px-10 md:pb-28 md:pt-24">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 font-display text-[clamp(2.75rem,7vw,4.9rem)] font-semibold leading-[1.02] tracking-[-0.035em] text-white">
            Building software that solves real problems.
          </h1>
          <p className="mt-7 max-w-2xl text-[17px] leading-[1.75] text-white/70 md:text-lg">
